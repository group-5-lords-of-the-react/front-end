...
function Restaurants() {
  ...
  useEffect(() => {
    const serverURL = `http://localhost:3026/?lat=31.945335&long=35.886671`;
    fetch(serverURL)
      .then((response) => {
    ...
    const serverURL2 = `http://localhost:3026/?lat=32.551445&long=35.851479`;
    fetch(serverURL2)
      .then((response) => {
        response.json().then((data) => {
          console.log(data);
    ...
    const serverURL3 = `http://localhost:3026/?lat=29.52667&long=35.00778`;
    fetch(serverURL3)
      .then((response) => {
        response.json().then((data) => {
          console.log(data);
